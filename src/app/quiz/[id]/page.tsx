    ...
    const fetchQuiz = async () => {
      try {
        ...
        const response = await fetch(
          `/api/quiz/${quizId}?studentId=${studentData.id}`
        );
    ...
    try {
      const response = await fetch("/api/attempts/save-answer", {
        ...
        body: JSON.stringify({
          ...
          isCorrect:
            choiceLetter ===
            quizData?.questions.find((q) => q.id === questionId)?.correctAnswer,
        }),
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-10">
      ...
      <div className="bg-white/80 backdrop-blur-lg shadow-lg border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            {/* Timer */}
            <div
              className={`flex items-center gap-2 px-4 py-2 rounded-xl font-mono text-lg sm:text-xl font-bold shadow-lg ${
                timeLeft <= 300
      ...
      <div className="max-w-4xl mx-auto px-2 py-3 ">
          ...
          <div className="lg:col-span-3">
                ...
                {currentQuestion.options.map((option, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <svg
                          className="flex-shrink-0 h-6 w-6 text-blue-600 ml-2"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
            ...
            {/* Submit Section - Prominent but Safe */}
              ...
              {unansweredCount > 0 && (
                <div className="bg-orange-50 border-2 border-orange-300 rounded-xl p-4 mb-6">
                  <div className="flex gap-3">
                    <svg
                      className="h-6 w-6 text-orange-600 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 leading-relaxed">
                      ...
                      <span className="font-bold">
                        you will NOT be able to change your answers or retake
                        this attempt
                      </span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600 mt-1">
                        You still have time to review your answers
                      </p>
                    </div>
                  </div>
                </div>
